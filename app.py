...
def load_model(model_name):
    if model_name == "sam2_hiera_large":
        model = build_sam2(
            config_path="segment_anything/sam2_configs/sam2_hiera_l.yaml",
            model_path="segment_anything/checkpoints/sam2_hiera_large.pt",
            device ='cuda', 
            apply_postprocessing=False
        )
    elif model_name == "sam2_hiera_small":
        model = build_sam2(
            config_path="segment_anything/sam2_configs/sam2_hiera_s.yaml",
            model_path="segment_anything/checkpoints/sam2_hiera_small.pt",
            device ='cuda', 
            apply_postprocessing=False
        )
    elif model_name == "sam2_hiera_tiny":
        model = build_sam2(
            config_path="segment_anything/sam2_configs/sam2_hiera_t.yaml",
            model_path="segment_anything/checkpoints/sam2_hiera_tiny.pt",
            device ='cuda', 
            apply_postprocessing=False
        )
    elif model_name == "sam2_hiera_base_plus":
        model = build_sam2(
            config_path="segment_anything/sam2_configs/sam2_hiera_b+.yaml",
            model_path="segment_anything/checkpoints/sam2_hiera_base_plus.pt",
            device ='cuda', 
            apply_postprocessing=False
        )
    else:
